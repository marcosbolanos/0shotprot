...
LOG_PATH="${LOG_PATH:-/tmp/latent_campaign_lgk_phase1a.log}"

echo "[latent-phase1a] gpu_uuid=${GPU_UUID} seeds=${SEED_START}-${SEED_END} log=${LOG_PATH}"
