...
SEED_END="${SEED_END:-5}"
LOG_PATH="${LOG_PATH:-/tmp/latent_campaign_lgk_phase1d_layer6_fix.log}"

echo "[latent-phase1d-fix] phase=phase1d_layer_6_fix steering_layer=5 (requested layer_6) gpu_uuid=${GPU_UUID} seeds=${SEED_START}-${SEED_END}"
